...
void ConfigManipulation::toggle_print_fff_options(DynamicPrintConfig* config)
{
    ...
    for (auto el : { "extra_perimeters","extra_perimeters_on_overhangs", "wave_overhangs", "thin_walls", "overhangs",
    ...
    for (auto el : { "wave_overhangs_instead_of_bridges", "wave_overhang_outer_perimeters", "wave_overhang_perimeter_overlap", "wave_overhang_narrow_split_threshold", "wave_overhang_pattern", "wave_overhang_line_spacing", "wave_overhang_line_width", "wave_overhang_flow_multiplier", "wave_overhang_print_speed",
    ...
    toggle_field("support_remaining_areas_after_wave_overhangs", have_support_material && have_wave_overhangs);
